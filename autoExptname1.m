function [ ExperimentName ] = autoExptname1(SavePath, mouse)
...
%check what experiments exist for today's date
    ...
    for i=1:26
        ...
        thisExptname = strcat(date,'_',mouse,'_',this_letter);
        thisFilename = strcat(SavePath,date,'_',mouse, '_',this_letter,'.mat');
